...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{picture/process_flow.png}
        \caption{Luồng xử lý lệnh GetProcesses}
        \label{fig:getprocesses_flow}
    \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{picture/killprocess_flow.png}
        \caption{Luồng xử lý lệnh KillProcess}
        \label{fig:killprocess_flow}
    \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{picture/startapp_flow.png}
        \caption{Luồng xử lý lệnh StartApplication}
        \label{fig:startapp_flow}
    \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{picture/screenshot_flow.png}
        \caption{Luồng xử lý lệnh RequestScreenshot}
...
\begin{enumerate}
    ...
    \item \textbf{Luồng xử lý StartKeylogger}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{picture/start_keylogger_flow.png}
        \caption{Luồng xử lý lệnh StartKeylogger}
        \label{fig:start_keylogger_flow}
    \end{figure}
    
    \item \textbf{Luồng xử lý StopKeylogger}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\linewidth]{picture/stop_keylogger_flow.png}
        \caption{Luồng xử lý lệnh StopKeylogger}
        \label{fig:stop_keylogger_flow}
    \end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Luồng xử lý Shutdown}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{picture/shutdown_flow.png}
        \caption{Luồng xử lý lệnh Shutdown}
        \label{fig:shutdown_flow}
    \end{figure}
    
    \item \textbf{Luồng xử lý Restart}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{picture/restart_flow.png}
        \caption{Luồng xử lý lệnh Restart}
        \label{fig:restart_flow}
    \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{picture/setregistry_flow.png}
        \caption{Luồng xử lý lệnh SetRegistry}
        \label{fig:setregistry_flow}
    \end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Luồng xử lý StartWebcam}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{picture/start_webcam_flow.png}
        \caption{Luồng xử lý lệnh StartWebcam}
        \label{fig:start_webcam_flow}
    \end{figure}
    
    \item \textbf{Luồng xử lý StopWebcam}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\linewidth]{picture/stop_webcam_flow.png}
        \caption{Luồng xử lý lệnh StopWebcam}
        \label{fig:stop_webcam_flow}
    \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{picture/systeminfo_flow.png}
        \caption{Luồng xử lý lệnh GetSystemInfo}
        \label{fig:systeminfo_flow}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{Kiến trúc Hub}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{picture/controlhub_architecture.png}
        \caption{Kiến trúc SignalR ControlHub}
        \label{fig:controlhub_architecture}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{Base64 Image Transfer Protocol}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{picture/base64_transfer.png}
        \caption{Luồng truyền ảnh qua Base64 encoding}
        \label{fig:base64_transfer}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{Auto-reconnection Mechanism}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{picture/autoreconnect_flow.png}
        \caption{Cơ chế tự động kết nối lại của client}
        \label{fig:autoreconnect_flow}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{JavaScript SignalR Client}:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{picture/js_signalr_client.png}
        \caption{JavaScript SignalR client architecture}
        \label{fig:js_signalr_client}
    \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{picture/error_handling.png}
        \caption{Error handling strategy của hệ thống}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{picture/system_overview.png}
    \caption{Tổng quan kiến trúc hệ thống Remote Control}
