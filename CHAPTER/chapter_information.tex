...
% Nhấn vào đây để truy cập tới video trình bày sản phẩm: \\ \href{https://www.youtube.com/watch?v=ujCWhZuEh4E}{https://www.youtube.com/watch?v=ujCWhZuEh4E}  
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{ % Tự động co bảng vừa chiều rộng trang
        \begin{tabular}{|c|l|l|c|}
            ...
            3                 & Chỉnh sửa video         & Đinh Dức Hiếu & 100\%       \\
            \hline
        \end{tabular}}
